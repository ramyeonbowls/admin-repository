    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="vertical-menu-template/dashboards-crm.html" target="_blank" class="menu-link">
                        <div class="text-truncate" data-i18n="CRM">CRM</div>
                        <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="vertical-menu-template/app-ecommerce-dashboard.html" target="_blank" class="menu-link">
                        <div class="text-truncate" data-i18n="eCommerce">eCommerce</div>
                        <div class="badge rounded-pill bg-label-primary text-uppercase fs-tiny ms-auto">Pro</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="vertical-menu-template/app-logistics-dashboard.html" target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="vertical-menu-template/app-email.html" target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="vertical-menu-template/app-chat.html" target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="vertical-menu-template/app-calendar.html" target="_blank" class="menu-link">
        ...
        <li class="menu-item">
            <a href="vertical-menu-template/app-kanban.html" target="_blank" class="menu-link">
        ...
        <!-- Form Validation -->
        <li class="menu-item">
            <a href="vertical-menu-template/form-validation.html" target="_blank" class="menu-link">
        ...
        <!-- Data Tables -->
        <li class="menu-item">
            <a href="vertical-menu-template/tables-datatables-basic.html" target="_blank" class="menu-link">
                <i class="menu-icon tf-icons bx bx-grid"></i>
